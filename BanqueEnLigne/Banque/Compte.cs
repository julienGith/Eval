...
namespace Banque
{
    public class Compte
    {
        ...
        public string CodeBanque
        {
            ...
            set
            {
                if (!IsCodeBanqueGuichetValid(value))
                {
                    throw new Exception();
                }
                _codeBanque = value; }
        ...
        #endregion
        /// <summary>
        /// Méthodes de contrôle de validité des champs.
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        #region
        public static bool IsCodeBanqueGuichetValid(string value)
        {
        ...
        public static bool IsNumeroCompteValid(string value)
        {
        ...
        public static bool IsLibelleCompteValid(string value)
        {
